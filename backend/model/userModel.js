...
const userSchema = new mongoose.Schema(
  {
    ...
    user_blocked: { type: Boolean, default: false },
    user_reported: [],
    user_verified: {
      type: String,
      default: "negative",
    ...
    recieve_notifications: { type: Boolean, default: false },
    ...
    otp_key: { type: String, default: "" },
    reset_count: { type: Number, default: 0 },
    last_reset_time: { type: Date, default: Date.now() },
